import { C as CustomError } from "./ts-custom-error.mjs";
...
var Exception = (
  /** @class */
  (function(_super) {
    __extends$19(Exception2, _super);
...
var ArgumentException = (
  /** @class */
  (function(_super) {
    __extends$18(ArgumentException2, _super);
...
var IllegalArgumentException = (
  /** @class */
  (function(_super) {
    __extends$17(IllegalArgumentException2, _super);
...
var ChecksumException = (
  /** @class */
  (function(_super) {
    __extends$16(ChecksumException2, _super);
...
var IndexOutOfBoundsException = (
  /** @class */
  (function(_super) {
    __extends$15(IndexOutOfBoundsException2, _super);
...
var ArrayIndexOutOfBoundsException = (
  /** @class */
  (function(_super) {
    __extends$14(ArrayIndexOutOfBoundsException2, _super);
...
var FormatException = (
  /** @class */
  (function(_super) {
    __extends$13(FormatException2, _super);
...
var UnsupportedOperationException = (
  /** @class */
  (function(_super) {
    __extends$12(UnsupportedOperationException2, _super);
...
var StringUtils = (
  ...
  (function() {
    ...
    StringUtils2.guessEncoding = function(bytes, hints) {
      if (hints !== null && hints !== void 0 && void 0 !== hints.get(DecodeHintType.CHARACTER_SET)) {
    ...
    BitMatrix2.prototype.setRegion = function(left, top, width, height) {
      ...
      for (var y = top; y < bottom; y++) {
        ...
        for (var x = left; x < right; x++) {
          bits[offset + (x >> 5)] |= 1 << (x & 31) & 4294967295;
        }
      }
    };
...
var NotFoundException = (
  /** @class */
  (function(_super) {
    __extends$11(NotFoundException2, _super);
...
var GlobalHistogramBinarizer = (
  /** @class */
  (function(_super) {
    __extends$10(GlobalHistogramBinarizer2, _super);
...
var InvertedLuminanceSource = (
  /** @class */
  (function(_super) {
    __extends$_(InvertedLuminanceSource2, _super);
...
var HTMLCanvasElementLuminanceSource = (
  /** @class */
  (function(_super) {
    __extends$Z(HTMLCanvasElementLuminanceSource2, _super);
...
var BrowserCodeReader = (
  ...
  (function() {
    ...
    BrowserCodeReader2.prototype.decode = function(element) {
      ...
      try {
        ...
        if (e instanceof NotFoundException) {
          ...
          var luminanceSource = new HTMLCanvasElementLuminanceSource(canvas, false);
    ...
    BrowserCodeReader2.prototype.createBinaryBitmap = function(mediaElement) {
      ...
      var luminanceSource = new HTMLCanvasElementLuminanceSource(canvas, doAutoInvert, this._grayscaleBuffer);
...
var ArithmeticException = (
  /** @class */
  (function(_super) {
    __extends$Y(ArithmeticException2, _super);
...
var ReedSolomonException = (
  /** @class */
  (function(_super) {
    __extends$W(ReedSolomonException2, _super);
...
var IllegalStateException = (
  /** @class */
  (function(_super) {
    __extends$V(IllegalStateException2, _super);
...
var AztecDetectorResult = (
  /** @class */
  (function(_super) {
    __extends$U(AztecDetectorResult2, _super);
...
var DefaultGridSampler = (
  /** @class */
  (function(_super) {
    __extends$T(DefaultGridSampler2, _super);
...
var Code128Reader = (
  /** @class */
  (function(_super) {
    __extends$R(Code128Reader2, _super);
...
var Code39Reader = (
  /** @class */
  (function(_super) {
    __extends$Q(Code39Reader2, _super);
...
var Code93Reader = (
  /** @class */
  (function(_super) {
    __extends$P(Code93Reader2, _super);
...
var UPCEANReader = (
  /** @class */
  (function(_super) {
    __extends$M(UPCEANReader2, _super);
...
var EAN13Reader = (
  /** @class */
  (function(_super) {
    __extends$L(EAN13Reader2, _super);
...
var EAN8Reader = (
  /** @class */
  (function(_super) {
    __extends$K(EAN8Reader2, _super);
...
var UPCEReader = (
  /** @class */
  (function(_super) {
    __extends$I(UPCEReader2, _super);
...
var MultiFormatUPCEANReader = (
  /** @class */
  (function(_super) {
    __extends$H(MultiFormatUPCEANReader2, _super);
...
var AbstractRSSReader = (
  /** @class */
  (function(_super) {
    __extends$F(AbstractRSSReader2, _super);
...
var DecodedChar = (
  /** @class */
  (function(_super) {
    __extends$E(DecodedChar2, _super);
...
var DecodedInformation = (
  /** @class */
  (function(_super) {
    __extends$D(DecodedInformation2, _super);
...
var DecodedNumeric = (
  /** @class */
  (function(_super) {
    __extends$C(DecodedNumeric2, _super);
...
var AI01decoder = (
  /** @class */
  (function(_super) {
    __extends$B(AI01decoder2, _super);
...
var AnyAIDecoder = (
  /** @class */
  (function(_super) {
    __extends$z(AnyAIDecoder2, _super);
...
var AI01weightDecoder = (
  /** @class */
  (function(_super) {
    __extends$y(AI01weightDecoder2, _super);
...
var AI013x0xDecoder = (
  /** @class */
  (function(_super) {
    __extends$x(AI013x0xDecoder2, _super);
...
var AI013103decoder = (
  /** @class */
  (function(_super) {
    __extends$w(AI013103decoder2, _super);
...
var AI01320xDecoder = (
  /** @class */
  (function(_super) {
    __extends$v(AI01320xDecoder2, _super);
...
var AI01392xDecoder = (
  /** @class */
  (function(_super) {
    __extends$u(AI01392xDecoder2, _super);
...
var AI01393xDecoder = (
  /** @class */
  (function(_super) {
    __extends$t(AI01393xDecoder2, _super);
...
var AI013x0x1xDecoder = (
  /** @class */
  (function(_super) {
    __extends$s(AI013x0x1xDecoder2, _super);
        ...
        if (r.getPairs().length !== pairs.length) {
          ...
          var _loop_1 = function(p2) {
            if (!pairs.some(function(otherPair) {
              return ExpandedPair.equals(p2, otherPair);
            })) {
              allFound = false;
              return "break";
            }
...
var MultiFormatOneDReader = (
  /** @class */
  (function(_super) {
    __extends$o(MultiFormatOneDReader2, _super);
...
var AlignmentPattern = (
  /** @class */
  (function(_super) {
    __extends$l(AlignmentPattern2, _super);
...
var FinderPattern = (
  /** @class */
  (function(_super) {
    __extends$k(FinderPattern2, _super);
...
var FinderPatternFinder = (
  ...
  (function() {
    ...
    FinderPatternFinder2.prototype.find = function(hints) {
      ...
      var pureBarcode = hints !== null && hints !== void 0 && void 0 !== hints.get(DecodeHintType.PURE_BARCODE);
      var image = this.image;
      var maxI = image.getHeight();
...
var MicroQRFormatInformation = (
  ...
  (function() {
    ...
    MicroQRFormatInformation2.numBitsDiffering = function(a, b) {
      return Integer.bitCount(a ^ b);
    };
...
var MicroQRBitMatrixParser = (
  ...
  (function() {
    ...
    MicroQRBitMatrixParser2.prototype.copyBit = function(x, y, bits) {
...
var MicroQRFinderPattern = (
  /** @class */
  (function(_super) {
    __extends$j(MicroQRFinderPattern2, _super);
...
var MicroQRDetector = (
  ...
  (function() {
    ...
    MicroQRDetector2.prototype.detect = function(hints) {
      var _a2;
      this.resultPointCallback = hints != null ? (_a2 = hints.get(DecodeHintType.NEED_RESULT_POINT_CALLBACK)) !== null && _a2 !== void 0 ? _a2 : null : null;
    ...
    MicroQRDetector2.prototype.findFinderPattern = function(hints) {
      ...
      var maxI = image.getHeight();
      var maxJ = image.getWidth();
      var tryHarder = hints != null && hints.get(DecodeHintType.TRY_HARDER) !== void 0;
...
var BitMatrixParser = (
  ...
  (function() {
    ...
    BitMatrixParser2.prototype.readCodewords = function() {
      ...
      for (var y = 0; y < height; y++) {
        var bitnrRow = BitMatrixParser2.BITNR[y];
        for (var x = 0; x < width; x++) {
          var bit = bitnrRow[x];
...
var DecodedBitStreamParser$1 = (
  ...
  (function() {
    ...
    DecodedBitStreamParser2.decode = function(bytes, mode) {
      ...
      switch (mode) {
        ...
        case 3: {
          var postcode = void 0;
          if (mode === 2) {
            var pc = DecodedBitStreamParser2.getPostCode2(bytes);
    ...
    DecodedBitStreamParser2.getInt = function(bytes, x) {
      var val = 0;
      for (var i = 0; i < x.length; i++) {
        val += DecodedBitStreamParser2.getBit(x[i], bytes) << x.length - i - 1;
      }
      return val;
    };
    ...
    DecodedBitStreamParser2.getMessage = function(bytes, start, len) {
      ...
      for (var i = start; i < start + len; i++) {
        var c = DecodedBitStreamParser2.SETS[set].charAt(bytes[i]);
        switch (c) {
          ...
          case DecodedBitStreamParser2.SHIFTE:
            lastset = set;
            set = c.charCodeAt(0) - DecodedBitStreamParser2.SHIFTA.charCodeAt(0);
            shift = 1;
            break;
      ...
      while (sb.length > 0 && sb[sb.length - 1] === DecodedBitStreamParser2.PAD) {
        sb.pop();
      }
      return sb.join("");
    };
...
var MaxiCodeReader = (
  ...
  (function() {
    ...
    MaxiCodeReader2.extractPureBits = function(image) {
      ...
      for (var y = 0; y < MaxiCodeReader2.MATRIX_HEIGHT; y++) {
        var iy = top + Math.min(Math.floor((y * height + height / 2) / MaxiCodeReader2.MATRIX_HEIGHT), height - 1);
        for (var x = 0; x < MaxiCodeReader2.MATRIX_WIDTH; x++) {
          var ix = left + Math.min(Math.floor((x * width + width / 2 + (y & 1) * Math.floor(width / 2)) / MaxiCodeReader2.MATRIX_WIDTH), width - 1);
          if (image.get(ix, iy)) {
            bits.set(x, y);
          }
        }
