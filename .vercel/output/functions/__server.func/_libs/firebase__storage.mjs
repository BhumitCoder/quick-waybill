import { _ as _isFirebaseServerApp, b as _registerComponent, r as registerVersion, S as SDK_VERSION, a as _getProvider, g as getApp } from "./firebase__app.mjs";
import { a as getModularInstance, F as FirebaseError, h as isCloudWorkstation, f as getDefaultEmulatorHostnameAndPort, p as pingServer, j as createMockUserToken } from "./firebase__util.mjs";
...
function getBytesInternal(ref2, maxDownloadSizeBytes) {
  ...
  return ref2.storage.makeRequestWithTokens(requestInfo, newBytesConnection).then((bytes) => bytes);
}
